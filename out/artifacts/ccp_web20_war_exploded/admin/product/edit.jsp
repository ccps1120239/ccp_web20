...
<HEAD>
	...
	<script type="text/javascript">
      $(function () {
           ...
           * 使用jQuery
           */
          //根据id获取到select下的option且option的value等于product的cid的option
          //获取到后，设置其属性默认选中为true
          $("#cid option[value='${product.cid}']").prop("selected", true);
          $("#hot option[value='${product.is_hot}']").prop("selected", true);
      });
...
<body>
<!--  -->
<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminUpdateProductServlet"
      method="post">
	<%--设置隐藏按钮，将pid传到后台--%>
